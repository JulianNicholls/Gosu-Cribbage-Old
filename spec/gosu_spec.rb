...
describe Cribbage::GosuCard do
  before :each do
    @card = Cribbage::GosuCard.new( 1, 1 )
  end

  it "should respond to set_display" do
    expect( @card.respond_to? :set_display ).to eq true
  end

  it "should respond to draw" do
    expect( @card.respond_to? :draw ).to eq true
  end
end
...
describe Cribbage::GosuHand do
  before :each do
    ...
    @hand = Cribbage::GosuHand.new( pack, nil, nil, nil, nil )
  end
  ...
  it "should render the hand as text" do
    @hand.cards = [FullPack::HA, FullPack::H5, FullPack::S5, FullPack::CJ, FullPack::HQ, FullPack::HK]
